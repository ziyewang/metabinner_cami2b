...
def cal_comp_cont_per_bin(bin_contig_names, seed_contig_dict, cont_weight, marker_set_name='bacar',cal_cont_strategy='checkm',rm_marker_minmax=False):
    """
...
def select_comp_cont_per_bin(bin_contig_names, bacar_seed_contig_dict,bacteria_seed_contig_dict, cont_weight,cal_cont_strategy='checkm',rm_marker_minmax=False):
    bacar_identified_marker_num, bacar_uniq_marker_gene_num, bacar_comp, bacar_cont, bacar_cc_score=cal_comp_cont_per_bin(bin_contig_names, bacar_seed_contig_dict,
                                                                                                                          cont_weight, marker_set_name='bacar',cal_cont_strategy=cal_cont_strategy,rm_marker_minmax=rm_marker_minmax)
    bacteria_identified_marker_num, bacteria_uniq_marker_gene_num, bacteria_comp, bacteria_cont, bacteria_cc_score=cal_comp_cont_per_bin(bin_contig_names, bacteria_seed_contig_dict,
