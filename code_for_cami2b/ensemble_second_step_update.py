...
em_mode = 'greedy_combo2_mypipeline'
...
with open (bacar_dict_out, 'rb') as f:
    bacar_seed_contig_dict = pickle.load(f)
...
with open (bacteria_dict_out, 'rb') as f:
    bacteria_seed_contig_dict = pickle.load(f)
        ...
        if primary_q == 100:
            ...
            if em_mode == 'greedy':
                ...
                if num_matched_bins >= 2:
                    ...
                    for i in range(2, min(5, num_matched_bins+1)):
...
while True:
    ...
    new_bin, removed_contigs, added_contigs = ensemble._reconstruct_match_sets(matched_sets[0],
                                                                               ...
                                                                               SEL_MIN_COMP,
                                                                               SEL_MAX_CONT,
                                                                               em_mode='combo2',cal_cont_strategy=cal_cont_strategy)
