...
cp -r ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined3comps.tsv
...
cp -r ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined2and3comps.tsv
