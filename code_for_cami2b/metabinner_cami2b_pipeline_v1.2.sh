...
python ${metabinner_path}/code_for_cami2b/ensemble_second_step_update.py \
...
second_method_name=greedy_combo2_mypipeline_sort_matches_maxaddsum_q_quality_filter_flag_True_dynamicsel_q_50.0_cont_weight_3_reprot_minq_10.0_sel_min_comp_0.0_sel_max_cont_100.0_add_matches_3_bins
...
cp -r ${path}/${Method_name}/addcallback/addrefined2and3comps/${second_method_name}_res.tsv ${output_dir}/metabinner_res/final_result_combo_greedy_combo2_mypipeline.tsv
sed -i "s/,/\t/g" ${output_dir}/metabinner_res/final_result_combo_greedy_combo2_mypipeline.tsv
