#分两步
#step 1
#cc_score>10 -> GREEDY（comp-5*cont）
#step 2
#match_set, if unanbious combo cc_score > 10 -> unanbious
#else -> consensus
...
SEL_MAX_CONT = 10.0 #add_argument('-y', '--sel_max_cont', help="maximum contamination of bin to consider during bin selection process", type=float, default=10)
...
#bin_dirs_file = '/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/metabinner_multiseed_update/component_result.X_t_notrans_bin_dirs.tsv'
#output_dir='/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/new_ensemble_strategy/em_res_X_t_notrans'

#bin_dirs_file = '/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/metabinner_multiseed_update/component_result.X_cov_notrans_bin_dirs.tsv'
#output_dir='/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/new_ensemble_strategy/em_res_X_cov_notrans'

#bin_dirs_file = '/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/metabinner_multiseed_update/component_result.X_cov_logtrans_bin_dirs.tsv'
#output_dir='/home/wangzy/data/cami2019/cami2b/output/use_solidbin_scriptes_get_kmer_cov/rhimgCAMI2_short_read_pooled_megahit_map/output/new_ensemble_strategy/em_res_X_cov_logtrans'
...
bin_dir = os.path.join(output_dir, em_mode +'_'+sort_quality_strategy+'_quality_filter_flag_'+quality_filter_flag+sel_q+cont_weight+reprot_minq+ add_matches+'_bins')
...
with open(out_file,'w') as handle_file:
    ...
    while True:
        ...
        new_bin, removed_contigs, added_contigs = ensemble._reconstruct_match_sets(matched_sets[0],
                                                                                   ...
                                                                                   SEL_MIN_COMP,
                                                                                   SEL_MAX_CONT,
                                                                                   em_mode=em_mode,cal_cont_strategy=cal_cont_strategy)
