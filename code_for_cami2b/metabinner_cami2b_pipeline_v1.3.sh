...
Method_name=my_pipeline_sort_matches_maxaddsum_q_quality_filter_flag_False_updatesel_q_20.0_cont_weight_5_reprot_minq_20.0_add_matches_2_bins
Method_name1=my_pipeline_sort_matches_maxaddsum_q_quality_filter_flag_False_updatesel_q_20.0_cont_weight_5_reprot_minq_20.0_add_matches_3_bins
...
python ${metabinner_path}/code_for_cami2b/ensemble_my_pipeline.py ${output_dir}/metabinner_res/ensemble/${contig_file_name}.bacar.seed.seed_contig_dict.pkl \
...
python ${metabinner_path}/code_for_cami2b/ensemble_my_pipeline.py \
...
${output_dir}/metabinner_res/ensemble/${contig_file_name}.bacar.seed.seed_contig_dict.pkl \
${output_dir}/metabinner_res/ensemble/${contig_file_name}.marker.seed.seed_contig_dict.pkl \
${path}/${Method_name}/addcallback/addrefined3comps_bins_dir.tsv \
${path}/${Method_name}/addcallback/addrefined3comps &
python ${metabinner_path}/code_for_cami2b/ensemble_my_pipeline_add_match3.py \
${output_dir}/metabinner_res/ensemble/${contig_file_name}.bacar.seed.seed_contig_dict.pkl \
${output_dir}/metabinner_res/ensemble/${contig_file_name}.marker.seed.seed_contig_dict.pkl \
${path}/${Method_name}/addcallback/addrefined2and3comps_bins_dir.tsv \
${path}/${Method_name}/addcallback/addrefined2and3comps &
...
python ${metabinner_path}/code_for_cami2b/maxbin_to_bin_zy.py \
--paths ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name} \
-o ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name}_res.tsv

cp -r ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined3comps_2match.tsv
sed -i "s/,/\t/g" ${output_dir}/metabinner_res/final_result_addrefined3comps_2match.tsv

python ${metabinner_path}/code_for_cami2b/maxbin_to_bin_zy.py \
--paths ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name} \
-o ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name}_res.tsv

cp -r ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined2and3comps_2match.tsv
sed -i "s/,/\t/g" ${output_dir}/metabinner_res/final_result_addrefined2and3comps_2match.tsv

python ${metabinner_path}/code_for_cami2b/maxbin_to_bin_zy.py \
--paths ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name1} \
-o ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name1}_res.tsv

cp -r ${path}/${Method_name}/addcallback/addrefined3comps/${Method_name1}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined3comps.tsv
sed -i "s/,/\t/g" ${output_dir}/metabinner_res/final_result_addrefined3comps.tsv

python ${metabinner_path}/code_for_cami2b/maxbin_to_bin_zy.py \
--paths ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name1} \
-o ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name1}_res.tsv

cp -r ${path}/${Method_name}/addcallback/addrefined2and3comps/${Method_name1}_res.tsv ${output_dir}/metabinner_res/final_result_addrefined2and3comps.tsv
sed -i "s/,/\t/g" ${output_dir}/metabinner_res/final_result_addrefined2and3comps.tsv
