...
input_dir="/mnt/data3/camiIIb/Rhizosphere_Assembly/assembly" #the dir to the input data
assembly="${input_dir}/rhimgCAMI2_short_read_pooled_megahit.fasta" #the file of the assembled contigs
mapdir="${input_dir}/rhimgCAMI2_short_read_pooled_megahit_map"   # the path to save the alignment files
read_dir="/mnt/data3/camiIIb/Rhizosphere_Raw_data/reads/short_reads" #the path where you put your reads in
