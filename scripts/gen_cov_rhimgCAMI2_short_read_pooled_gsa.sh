...
assembly="${input_dir}/rhimgCAMI2_short_read_pooled_gsa.fasta" #the file of the assembled contigs
mapdir="${input_dir}/rhimgCAMI2_short_read_pooled_gsa_map"   # the path to save the alignment files
